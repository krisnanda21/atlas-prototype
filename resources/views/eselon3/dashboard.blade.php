...
<div class="page-header">
    <h1 style="font-size:30px">🏠 Dashboard Unit Kerja</h1>
...
<div style="display:grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-bottom: 20px;">
        ...
        <div class="card" style="display:flex; flex-direction:column; justify-content:space-between; padding:24px;">
            <div>
                ...
                <div style="display:flex; flex-direction:column; gap:12px; margin-top:16px;">
                    <div style="display:flex; justify-content:space-between; align-items:center; padding-bottom:8px; border-bottom:1px solid #E2E8F0; font-size:13px;">
            ...
            <div style="background:#F8FAFC; border-radius:8px; padding:16px; margin-top:20px; border:1px solid #E2E8F0;">
    ...
    <div style="display:flex; flex-direction:column; gap:20px;">
        ...
        <div class="card" style="padding:24px; flex-grow:1;">
            <div class="card-title" style="font-size:18px">📉 Gap Kompetensi Terbanyak</div>
