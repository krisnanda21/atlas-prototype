...
function showConfirmApprovePlan(id, title) {
    ...
    document.getElementById('form-approve-plan').action = '/eselon3/penetapan-bangkom/' + id + '/approve';
...
function openRejectPlanModal(id, title) {
    ...
    document.getElementById('form-reject-plan').action = '/eselon3/penetapan-bangkom/' + id + '/reject';
...
function showConfirmApproveRealisasi(id, title) {
    ...
    document.getElementById('form-approve-realisasi').action = '/eselon3/penetapan-bangkom/' + id + '/approve-realisasi';
...
function openRejectRealisasiModal(id, title) {
    ...
    document.getElementById('form-reject-realisasi').action = '/eselon3/penetapan-bangkom/' + id + '/reject-realisasi';
