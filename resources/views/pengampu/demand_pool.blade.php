...
<div class="card mb-4">
    ...
    <div style="display:grid; grid-template-columns:repeat(4,1fr); gap:14px; overflow-x:auto;">
        ...
        <div style="background:rgba(45,140,240,0.06); border:1px solid rgba(45,140,240,0.2); border-radius:10px; padding:12px; display:flex; flex-direction:column;">
            <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:10px; padding-bottom:8px; border-bottom:1px solid rgba(45,140,240,0.15);">
                ...
                <span class="badge" style="background:rgba(45,140,240,0.2); color:var(--accent); font-size:10px; font-weight:700; padding:2px 6px;">{{ $kanbanStrategic->count() }}</span>
            </div>
            <div style="display:flex; flex-direction:column; gap:8px; max-height:300px; overflow-y:auto; padding-right:4px;">
                ...
                <div style="background:rgba(255,255,255,0.05); border:1px solid rgba(255,255,255,0.08); border-radius:8px; padding:10px; font-size:12px; transition:transform 0.15s ease;">
        ...
        <div style="background:rgba(245,158,11,0.06); border:1px solid rgba(245,158,11,0.2); border-radius:10px; padding:12px; display:flex; flex-direction:column;">
            ...
            <div style="display:flex; flex-direction:column; gap:8px; max-height:300px; overflow-y:auto; padding-right:4px;">
                ...
                <div style="background:rgba(255,255,255,0.05); border:1px solid rgba(255,255,255,0.08); border-radius:8px; padding:10px; font-size:12px;" title="Pegawai: {{ implode(', ', $need->employees) }}">
        ...
        <div style="background:rgba(34,197,94,0.06); border:1px solid rgba(34,197,94,0.2); border-radius:10px; padding:12px; display:flex; flex-direction:column;">
            ...
            <div style="display:flex; flex-direction:column; gap:8px; max-height:300px; overflow-y:auto; padding-right:4px;">
                ...
                <div style="background:rgba(255,255,255,0.05); border:1px solid rgba(255,255,255,0.08); border-radius:8px; padding:10px; font-size:12px;">
    ...
    <div class="category-section" id="section-teknis" style="margin-bottom:28px;">
        <div style="display:flex; justify-content:space-between; align-items:center; background:rgba(56,189,248,0.08); border-left:4px solid var(--accent); padding:10px 14px; border-radius:0 8px 8px 0; margin-bottom:12px;">
            <div style="display:flex; align-items:center; gap:8px;">
                ...
                <span class="badge" style="background:rgba(45,140,240,0.2); color:var(--accent); font-size:10px; font-weight:700; padding:2px 8px;" id="count-teknis">
...
{{-- Modal Detail Demand --}}
<div id="modal-demand" style="display:none;position:fixed;inset:0;background:rgba(0,0,0,0.6);z-index:1000;align-items:center;justify-content:center;">
    <div style="background:#1a2e45;border:1px solid rgba(255,255,255,0.1);border-radius:12px;padding:28px;width:780px;max-height:85vh;overflow-y:auto;">
        ...
        <form method="POST" action="{{ route('pengampu.storeRencanaBangkom') }}" id="form-kegiatan">
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:16px;margin-bottom:14px;">
                ...
                <div class="form-group" style="text-align:left;">
                    ...
                    <input type="text" name="kompetensi_dasar" id="input-kompetensi-dasar" class="form-control" style="background:#1a2e45;color:#fff;width:100%;padding:10px;border-radius:6px;border:1px solid rgba(255,255,255,0.1);font-size:13px;" required readonly>
                </div>
            </div>
