...
<div id="modal-add" style="display:none;position:fixed;inset:0;background:rgba(15,23,42,0.85);backdrop-filter:blur(6px);z-index:9999;align-items:center;justify-content:center;opacity:0;transition:opacity 0.2s ease-in-out;">
    <div style="background:#1e293b;border:1px solid rgba(255,255,255,0.1);border-radius:12px;padding:28px;width:95%;max-width:700px;max-height:85vh;overflow-y:auto;box-shadow:0 25px 50px -12px rgba(0,0,0,0.5);transform:scale(0.95);transition:transform 0.2s ease-in-out;font-family:'Inter', sans-serif;" id="modal-add-content">
        <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:20px;border-bottom:1px solid rgba(255,255,255,0.05);padding-bottom:12px;">
            <h2 style="font-size:18px;font-weight:700;color:#fff;margin:0;">📅 + Buat Rencana Kegiatan dari Arahan Strategis</h2>
        ...
        <form method="POST" action="{{ route('pengampu.storeRencanaBangkom') }}" id="form-kegiatan" onsubmit="return validateFormDates()">
            ...
            <div class="form-group" style="margin-bottom:14px; text-align:left;">
                ...
                <input type="text" name="nama_kegiatan" id="input-nama-kegiatan" class="form-control" style="background:#1a2e45;color:#fff;width:100%;padding:10px;border-radius:6px;border:1px solid rgba(255,255,255,0.1);font-size:13px;" required placeholder="Nama kegiatan bangkom unit" maxlength="999">
            </div>
            ...
            <div class="form-group" style="margin-bottom:14px; text-align:left;">
                ...
                <input type="text" name="indikator_kinerja" id="input-indikator-kinerja" class="form-control" style="background:#1a2e45;color:#fff;width:100%;padding:10px;border-radius:6px;border:1px solid rgba(255,255,255,0.1);font-size:13px;" required placeholder="Indikator kinerja terkait" maxlength="999">
            </div>
            ...
            <div style="display:grid;grid-template-columns:1fr 1.5fr;gap:16px;margin-bottom:14px;">
                ...
                <div class="form-group" style="text-align:left;">
                    ...
                    <input type="text" name="latar_belakang" id="input-latar-belakang" class="form-control" style="background:#1a2e45;color:#fff;width:100%;padding:10px;border-radius:6px;border:1px solid rgba(255,255,255,0.1);font-size:13px;" required placeholder="Deskripsi latar belakang" maxlength="999">
                </div>
            </div>
...
function addRepeaterRow(containerId, namePrefix, initialValue = '') {
    ...
    input.style.cssText = 'background:#1a2e45;color:#fff;flex:1;padding:8px;border-radius:6px;border:1px solid rgba(255,255,255,0.1);font-size:13px;';
