@extends('layouts.app')
@section('title', 'Profil 360 - Pengampu SDM')
@section('header_title', 'Profil 360° Kompetensi Pegawai')

@section('content')
<div class="page-header">
    <h1>🔮 Profil 360° Kompetensi Pegawai Unit</h1>
</div>
...
<div>
        ...
        <div class="card" style="margin-top:20px;">
            ...
            <table id="table-idp" data-page-size="5">
                <thead>
                    <tr><th>Kebutuhan</th><th>Sumber</th><th>Prioritas</th><th>Status</th></tr>
                </thead>
                <tbody>
        ...
        <div class="card" style="text-align:center;padding:60px;">
            <div style="font-size:48px;margin-bottom:12px;">👤</div>
            <p class="text-muted">Pilih pegawai dari daftar di sebelah kiri untuk melihat profilnya.</p>
        </div>
        @endif
    </div>
@endif
