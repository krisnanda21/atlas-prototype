...
<form method="GET" action="{{ route('eselon2.talentFinder') }}" id="filter-form">
    ...
    <div class="card mb-4" style="position: relative; z-index: 100;">
        ...
        <div style="display: flex; gap: 12px; justify-content: flex-end; margin-top: 24px; border-top: 1px solid rgba(255,255,255,0.05); padding-top: 16px;">
            <a href="{{ route('eselon2.talentFinder') }}" class="btn btn-neutral">Reset</a>
        ...
        <table class="table" style="width: 100%;">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    @endif
                    <td style="padding: 16px; border-bottom: 1px solid rgba(255,255,255,0.05); text-align: center;">
                        <a href="{{ route('eselon2.profil360', ['q' => $emp->id]) }}" class="btn btn-sm btn-primary" style="display: inline-flex; align-items: center; justify-content: center; gap: 6px; font-weight: 600; padding: 6px 14px; border-radius: 6px; box-shadow: 0 2px 4px rgba(59,130,246,0.2);">
