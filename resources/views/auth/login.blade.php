...
<head>
    ...
    <style>
        ...
        .form-label { display: block; font-size: 12px; font-weight: 600; color: var(--text-muted, #8899aa); text-transform: uppercase; letter-spacing: .06em; margin-bottom: 6px; }
        .form-input {
            width: 100%;
...
<div class="login-page">
    <div class="login-card">
        ...
        <p class="text-sm text-muted" style="text-align:center;font-size:11px;color:rgba(255,255,255,.25);">
