...
class Eselon3Controller extends Controller
{
    /**
    ...
    public function dashboard(Request $request)
    {
        ...
        return view('eselon3.dashboard', compact(
    ...
    public function arahanStrategis(Request $request)
    {
        ...
        return view('eselon3.arahan_strategis', compact('directions', 'allCompetencies', 'kompetensiTeknis', 'kompetensiMansoskul'));
    }
    ...
    public function reviewIdp(Request $request)
    {
        ...
        return view('eselon3.review_idp', compact('groupedIdps', 'search', 'user'));
    }
    ...
    public function penetapanBangkom(Request $request)
    {
        ...
        return view('eselon3.penetapan_bangkom', compact('plans'));
    }
    ...
    public function pembatalanBangkom(Request $request)
    {
        ...
        return view('eselon3.pembatalan_bangkom', compact('plans'));
    }
    ...
    public function profil360(Request $request)
    {
        ...
        return view('eselon3.profil_360', compact('employee', 'employees', 'needs', 'idpItems', 'search', 'diklats', 'sertifikasis', 'bangkoms'));
    }
}
